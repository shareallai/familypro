...
- Default to written, concise, scenario-led prose: keep the user's actual problem in view, remove generic setup, and avoid mechanical "three points / FAQ / summary" structure unless it improves readability.
