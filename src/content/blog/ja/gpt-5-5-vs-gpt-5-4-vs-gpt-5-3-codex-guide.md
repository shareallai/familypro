...
description: "2026年8月28日更新。GPT-5.3 Codex、GPT-5.4、GPT-5.5の性能、APIコスト、用途を比較し、既存環境を移行すべきか判断する基準を整理します。"
...
本記事は、GPT-5.3 Codex、GPT-5.4、GPT-5.5を現在も利用・評価しているチーム向けです。新規導入では、現行のGPT-5.6系も同じ評価に加えてください。仕様と価格はOpenAI公式ドキュメントで **2026-08-28** に再確認しました。価格情報は参考値です。
...
| GPT-5.5 | 2026-04-23（APIは2026-04-24） | リリース時のフラッグシップ。複雑な実業務での計画・実行・自己検証を強化 | 高難度なagenticワークフロー、E2E実行 |
