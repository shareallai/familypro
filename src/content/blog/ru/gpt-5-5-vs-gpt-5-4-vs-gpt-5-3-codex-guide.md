...
description: "Обновлено 28 августа 2026 года: сравнение GPT-5.3 Codex, GPT-5.4 и GPT-5.5 по возможностям, цене API, сценариям и смыслу миграции."
...
Материал предназначен для команд, которые всё ещё используют или оценивают GPT-5.3 Codex, GPT-5.4 и GPT-5.5. Для нового проекта стоит включить в тот же тест актуальную линейку GPT-5.6. Характеристики и цены повторно проверены по официальной документации OpenAI **2026-08-28**; цены указаны только для справки.
...
| GPT-5.5 | 2026-04-23 (API: 2026-04-24) | Флагман на момент релиза для сложной работы с усиленным планированием и самопроверкой | Сложные agentic-процессы и end-to-end исполнение |
